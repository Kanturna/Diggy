...
const EARTH_VARIANT_COUNT := 17

const CREATURE_SPAWN_COUNT := 10
const CREATURE_SPAWN_ATTEMPTS := 1200
const CREATURE_SPAWN_PADDING_CELLS := 4
const CREATURE_BODY_WIDTH_CELLS := 2.0
const CREATURE_BODY_LENGTH_CELLS := 4.0
const CREATURE_TAIL_SEGMENTS := 5
const CREATURE_SPEED_CELLS_PER_SECOND := 5.5
const CREATURE_TURN_INTERVAL_MIN := 0.7
const CREATURE_TURN_INTERVAL_MAX := 1.6
